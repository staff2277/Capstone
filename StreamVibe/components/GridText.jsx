    ...
    <div className="text-center">
      <div className="">
        ...
        <div className="flex justify-center">
          <button className="flex items-center gap-3 whitespace-nowrap rounded-lg bg-[#E50000] normal-case hover:bg-[#3a3a3a] focus:bg-[#3f3f3f] active:bg-[#3f3f3f] focus:outline-none focus:ring focus:ring-[#cac8c896] max-5s:px-[1rem] max-5s:py-[0.5rem] max-5s:text-[0.9rem] max-5s:mt-[10px] 5s:mt-8 5s:px-[2rem] 5s:py-[1rem] sm:px-[3rem] sm:py-[1.3rem]">
