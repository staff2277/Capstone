"""
Django settings for streamvibe_config project.
...
ROOT_URLCONF = 'streamvibe_config.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR,"StreamVibe/dist")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'streamvibe_config.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "StreamVibe/dist")
]
